...
./plot-summary-xy.py -i summary-citation-matching-not-null-ratio-0.5.csv -m jaccard -t "Precision v.s. Recall for Citation Matching (Jaccard of citations), NNR >= 0.5" -x Recall -y Precision -c F1 -o summary_plots/citation-matching-nnr-0.5-jaccard/citation-matching-nnr-0.5-jaccard-xy-precision-recall.png --no-show
...
./plot-summary-xy.py -i summary-citation-matching-not-null-ratio-0.6.csv -m jaccard -t "Precision v.s. Recall for Citation Matching (Jaccard of citations), NNR >= 0.6" -x Recall -y Precision -c F1 -o summary_plots/citation-matching-nnr-0.6-jaccard/citation-matching-nnr-0.6-jaccard-xy-precision-recall.png --no-show
...
./plot-summary-xy.py -i summary-citation-matching-not-null-ratio-0.7.csv -m jaccard -t "Precision v.s. Recall for Citation Matching (Jaccard of citations), NNR >= 0.7" -x Recall -y Precision -c F1 -o summary_plots/citation-matching-nnr-0.7-jaccard/citation-matching-nnr-0.7-jaccard-xy-precision-recall.png --no-show
...
./plot-summary-xy.py -i summary-citation-matching-not-null-ratio-0.8.csv -m jaccard -t "Precision v.s. Recall for Citation Matching (Jaccard of citations), NNR >= 0.8" -x Recall -y Precision -c F1 -o summary_plots/citation-matching-nnr-0.8-jaccard/citation-matching-nnr-0.8-jaccard-xy-precision-recall.png --no-show
...
./plot-summary-xy.py -i summary-citation-matching-not-null-ratio-0.9.csv -m jaccard -t "Precision v.s. Recall for Citation Matching (Jaccard of citations), NNR >= 0.9" -x Recall -y Precision -c F1 -o summary_plots/citation-matching-nnr-0.9-jaccard/citation-matching-nnr-0.9-jaccard-xy-precision-recall.png --no-show
...
./plot-summary-xy.py -i summary-citation-matching-not-null-ratio-1.0.csv -m jaccard -t "Precision v.s. Recall for Citation Matching (Jaccard of citations), NNR >= 1.0" -x Recall -y Precision -c F1 -o summary_plots/citation-matching-nnr-1.0-jaccard/citation-matching-nnr-1.0-jaccard-xy-precision-recall.png --no-show
