...
./plot-summary-xy.py -i summary-title-OR-citation-matching-not-null-ratio-0.5.csv -m jaccard -t "Joint (M: Jaccard of citations), NNR >= 0.5" -x Recall -y Precision -c F1 -o summary_plots/title-OR-citation-matching-nnr-0.5-jaccard/title-OR-citation-matching-nnr-0.5-jaccard-xy-precision-recall.png --no-show
...
./plot-summary-xy.py -i summary-title-OR-citation-matching-not-null-ratio-0.6.csv -m jaccard -t "Joint (M: Jaccard of citations), NNR >= 0.6" -x Recall -y Precision -c F1 -o summary_plots/title-OR-citation-matching-nnr-0.6-jaccard/title-OR-citation-matching-nnr-0.6-jaccard-xy-precision-recall.png --no-show
...
./plot-summary-xy.py -i summary-title-OR-citation-matching-not-null-ratio-0.7.csv -m jaccard -t "Joint (M: Jaccard of citations), NNR >= 0.7" -x Recall -y Precision -c F1 -o summary_plots/title-OR-citation-matching-nnr-0.7-jaccard/title-OR-citation-matching-nnr-0.7-jaccard-xy-precision-recall.png --no-show
...
./plot-summary-xy.py -i summary-title-OR-citation-matching-not-null-ratio-0.8.csv -m jaccard -t "Joint (M: Jaccard of citations), NNR >= 0.8" -x Recall -y Precision -c F1 -o summary_plots/title-OR-citation-matching-nnr-0.8-jaccard/title-OR-citation-matching-nnr-0.8-jaccard-xy-precision-recall.png --no-show
...
./plot-summary-xy.py -i summary-title-OR-citation-matching-not-null-ratio-0.9.csv -m jaccard -t "Joint (M: Jaccard of citations), NNR >= 0.9" -x Recall -y Precision -c F1 -o summary_plots/title-OR-citation-matching-nnr-0.9-jaccard/title-OR-citation-matching-nnr-0.9-jaccard-xy-precision-recall.png --no-show
...
./plot-summary-xy.py -i summary-title-OR-citation-matching-not-null-ratio-1.0.csv -m jaccard -t "Joint (M: Jaccard of citations), NNR >= 1.0" -x Recall -y Precision -c F1 -o summary_plots/title-OR-citation-matching-nnr-1.0-jaccard/title-OR-citation-matching-nnr-1.0-jaccard-xy-precision-recall.png --no-show
